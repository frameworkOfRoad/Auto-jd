...
let exchangeFlag = 1;//是否开启自动抽奖，建议活动快结束开启，默认关闭
...
const author_codes = ['RtGKi5_ZEHTkJN79YpZymofOkJLOAyXJ6Z94tPbFQtTbJ2Xq'].sort(() => 0.5 - Math.random())
const self_code = []
let pool = []
!(async () => {
  if (!cookiesArr[0]) {
